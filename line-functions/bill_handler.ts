...
📂 ตัดสินใจ category ตามลำดับ:
  ...
  ⚡ Priority 2: น้ำมัน
     ...
     【1】 ดูช่อง "TOTAL / รวม / รวมเงิน" ก่อนเสมอ
            ถ้ามีเลข → ใช้เลขนั้นเป็น amount เลย ไม่ต้องคูณเอง
            เช่น บิลวนิดาพานิช: เขียน "360 x 38.79" + ช่อง TOTAL = 13,964
              → liters=360, amount=13964 (เอามาจาก TOTAL)

     【2】 ถ้าไม่เห็น TOTAL แต่มี "NNN x NN.NN" เขียนมือ → คำนวณ liters × rate
            ตัวอย่าง: "380 x 38.79" → liters=380, amount=14740
            ตัวอย่าง: "360 x 38.79" → liters=360, amount=13964
